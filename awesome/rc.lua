...
beautiful.init(gears.filesystem.get_configuration_dir() .. "themes/lukas/theme.lua")
-- naughty.notify({ text=gears.filesystem.get_configuration_dir() .. "themes/lukas/theme.lua" })
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey }, "e", function () awful.client.focus.bydirection("up") end,
